...
export default {
  ...
  methods: {
    ...
    updateSort() {
      ...
      _this.$ajax.post("http://127.0.0.1:9000/business/admin/course/sort", _this.sort).then((res) => {
        let response = res.data;
    ...
    listContentFiles() {
      let _this = this;
      _this.$ajax.get('http://127.0.0.1:9000/business/admin/course-content-file/list/' + _this.course.id).then((response) => {
        let resp = response.data;
        if (resp.success) {
    ...
    afterUploadContentFile(response) {
      ...
      file.url = file.path;
      _this.$ajax.post('http://127.0.0.1:9000/business/admin/course-content-file/save', file).then((response) => {
        let resp = response.data;
        if (resp.success) {
    ...
    delFile(f) {
      let _this = this;
      Confirm.show("删除课程后不可恢复，确认删除？", function () {
        _this.$ajax.delete('http://127.0.0.1:9000/business/admin/course-content-file/delete/' + f.id).then((response) => {
          let resp = response.data;
          if (resp.success) {
