          ...
          <div class="widget-body">
            <div class="widget-main no-padding">
              <table class="table table-bordered table-striped">
                ...
                <tr>
                  <td>SpringCloud+Vue前后端分离开发在线视频课程系统</td>
                ...
                <tr>
                  <td>SpringBoot+Vue3前后端分离 实战wiki知识库系统</td>
...
export default {
  ...
  methods: {
    ...
    drawPieChart() {
      ...
      let data = [
        {label: "Java", data: 38.7, color: "rgba(104,188,49,0.49)"},
        {label: "Python", data: 24.5, color: "rgba(139,202,248,0.7)"},
        {label: "Android", data: 18.6, color: "#f3d0eb"},
        {label: "其它", data: 10, color: "rgba(254,224,116,0.62)"},
      ];
