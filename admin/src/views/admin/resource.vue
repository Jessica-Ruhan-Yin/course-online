...
export default {
  ...
  methods: {
    ...
    list(page) {
      let _this = this;
      _this.$ajax.post('http://127.0.0.1:9000/system/admin/resource/list', {
        page: page,
    ...
    save() {
      ...
      _this.$ajax.post('http://127.0.0.1:9000/system/admin/resource/save', _this.resource).then((response) => {
        let resp = response.data;
        if (resp.success) {
